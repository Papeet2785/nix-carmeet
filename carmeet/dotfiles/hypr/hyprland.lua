...
hl.bind("SUPER + C", hl.dsp.exec_cmd("ghostty -e hx ~"))
hl.bind("SUPER + SHIFT + C", hl.dsp.exec_cmd("ghostty -e hx ~/nix-carmeet"))
hl.bind("SUPER + ESCAPE", hl.dsp.exec_cmd("ghostty -e btop"))
